...
bool SPI::Start() const noexcept
{
    ...
    WriteByte(0x7F ,ControlBytes.COMMAND_MODE, Pins.DC);
    WriteByte(Commands.SET_PRECHARGE_PERIOD ,ControlBytes.COMMAND_MODE, Pins.DC);
    WriteByte(0xF1 ,ControlBytes.COMMAND_MODE, Pins.DC);
    ...
    WriteByte(0x14 ,ControlBytes.COMMAND_MODE, Pins.DC);
    WriteByte(Commands.SET_MEMORY_ADDRESSING_MODE,ControlBytes.COMMAND_MODE, Pins.DC);
    WriteByte(0x02,ControlBytes.COMMAND_MODE, Pins.DC); // 0x02 = Page Addressing
